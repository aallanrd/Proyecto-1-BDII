...
public class ViewProduct extends javax.swing.JDialog {
     ...
     */
    public ViewProduct(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton2.setText("Hacer Nueva Compra");

        jLabel2.setText("Nombre:");

        jLabel3.setText("Familia:");

        jLabel4.setText("Precio Dolar:");

        jLabel5.setText("Unidad Medida");

        jLabel6.setText("Usuario Inserto:");

        jLabel7.setText("Ultimo Usr.Modif.:");

        jLabel8.setText("Fecha Ult. Modif.:");

        jCheckBox1.setBackground(new java.awt.Color(255, 255, 255));
        jCheckBox1.setText("Caracteristicas");

        jCheckBox2.setBackground(new java.awt.Color(255, 255, 255));
        jCheckBox2.setText("Ensamblado");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewProduct dialog = new ViewProduct(new javax.swing.JDialog(), true);
